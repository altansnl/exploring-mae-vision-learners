...
if __name__ == "__main__":
    ...
    parser.add_argument('--embed_dim',  type=int, default=1024, help='encoder embedding dimensionality')
    parser.add_argument('--hidden_dim_ratio',  type=float, default=.4, help='encoder hidden dimension ratio')   
    parser.add_argument('--num_heads',  type=int, default=16, help='encoder number of heads')
    parser.add_argument('--num_layers',  type=int, default=16, help='number of transformer layers in the encoder')
    parser.add_argument('--patch_size',  type=int, default=16, help='patch size')
    parser.add_argument('--decoder_embed_dim',  type=int, default=1024, help='decoder embedding dimensionality')
